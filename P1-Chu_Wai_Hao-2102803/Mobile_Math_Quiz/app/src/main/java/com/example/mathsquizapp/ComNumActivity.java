...
public class ComNumActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    int totalQuestion = ComNumQues.question1.length;
    String selectedAns = "";
    ...
    public void onClick(View v) {
        ...
        if (clickButton.equals(submit)){
            ...
            if (selectedAns.equals(ComNumQues.answer1[(int) List.get(questionIndex)])){
                score++;
            }
    ...
    ArrayList List = getRandomNonRepeatingIntegers(ComNumQues.question1.length, 0, (ComNumQues.question1.length-1));
    void loadNewQuestion(){
        ...
        question.setText(ComNumQues.question1[(int) List.get(questionIndex)]);
        opt1.setText(ComNumQues.choice1[(int) List.get(questionIndex)][0]);
        opt2.setText(ComNumQues.choice1[(int) List.get(questionIndex)][1]);
        opt3.setText(ComNumQues.choice1[(int) List.get(questionIndex)][2]);
    ...
    void finishQuiz(){
        countDownTimer.cancel();
        Intent intent = new Intent(ComNumActivity.this,ResultScore.class);
    ...
    void showAns(){
        ...
        //opt1
        if (b1.equals(ComNumQues.answer1[(int) List.get(questionIndex)])){
        ...
        if (b2.equals(ComNumQues.answer1[(int) List.get(questionIndex)])){
        ...
        if (b3.equals(ComNumQues.answer1[(int) List.get(questionIndex)])){
